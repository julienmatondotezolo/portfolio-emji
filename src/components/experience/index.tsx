...
const hardcodedExperiences = [
  {
    ...
    points: [
      'E2E testing on the FiDigO project for digital meter infrastructure',
      'Developed automated test suites using Playwright',
      'Collaborated with cross-functional teams using JIRA and SAP integration',
    ],
  ...
  },
  {
    ...
    points: [
      'QA Engineer on the EUNOME project',
      'Defined and executed comprehensive test strategies',
      'Automated tests using Playwright and Selenium',
    ],
  ...
  },
  {
    ...
    points: [
      'Led Selenium to Playwright migration on Cascada 2.0 project',
      'Designed and maintained automated test frameworks',
      'Implemented CI/CD pipeline integration for test automation',
      '2+ years of continuous test automation engineering',
    ],
  ...
  },
  {
    ...
    points: [
      'Built test automation frameworks using Selenium WebDriver',
      'Test management with XRAY and JIRA integration',
      'Implemented CI/CD pipelines with Jenkins',
      'Applied JUnit for unit and integration testing',
    ],
  ...
  },
  {
    ...
    points: [
      'Quality assurance for restaurant tablet applications',
      'Manual testing and bug reporting',
      'Contributed to product quality improvement',
    ],
    color: 'from-teal-400 to-teal-600',
  },
  {
    id: '6',
    jobTitle: 'Junior Full Stack Developer (Internship)',
    company: 'Bothive',
    location: 'Belgium',
    ...
    points: [
      ...
      'Worked on the Liquid template editor',
