...
export function BackgroundCircles() {
  return (
    <div className="relative flex justify-center items-center">
      <div className="absolute border [#202020] rounded-full h-[200px] w-[200px] mt-52 animate-ping" />
      ...
      <div className="absolute border border-[#303030] rounded-full h-[800px] w-[800px] mt-52" />
    </div>
  );
}
